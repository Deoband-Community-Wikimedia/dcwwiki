...
class Data
{
    ...
    public function register_taxonomies()
    {
        ...
        if ( Utils::get_setting( 'enable_group_taxonomy' ) ) {
            ...
            if ( Utils::has_archive() && Utils::has_archive( 'group' ) ) {
                $args['public'] = true;
                $args['rewrite'] = [
                    'slug'         => Utils::get_archive_slug( 'group' ),
                    'with_front'   => true,
                    'hierarchical' => false,
                ];
            }
            
            register_taxonomy( Utils::get_taxonomy_name( 'group' ), array( Utils::post_type_name() ), $args );
        }
