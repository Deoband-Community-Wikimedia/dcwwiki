...
class Utils
{
    ...
    static function get_options_thumbnail_type( $excludes = array() )
    {
        $options = [ [
    ...
    {
        if ( $taxonomy ) {
            return wp_validate_boolean( self::get_setting( 'enable_' . $taxonomy . '_archive' ) );
        }
    ...
    {
        $taxonomies = [];
        if ( self::get_setting( 'enable_group_taxonomy' ) ) {
            $taxonomies[] = self::get_taxonomy_name( 'group' );
        }
        if ( $is_field ) {
    ...
    public static function get_the_title_template( $args = array() )
    {
        $args = shortcode_atts( [
            'card_action' => 'single-page',
            'tag'         => 'h3',
    ...
    public static function get_the_thumbnail_template( $args = array() )
    {
        $args = shortcode_atts( [
            'context'               => 'general',
            'card_action'           => 'single-page',
    ...
    public static function get_the_ribbon( $post_id, $args = array() )
    {
        $args = shortcode_atts( [
            'context' => 'general',
            'class'   => '',
    ...
    public static function get_the_ribbon_template( $args = array() )
    {
        $args = shortcode_atts( [
            'context' => 'general',
            'class'   => '',
    ...
    public static function get_the_designation_template( $args = array() )
    {
        $args = shortcode_atts( [
            'context' => 'general',
            'tag'     => 'h4',
    ...
    public static function get_the_excerpt_template( $args = array() )
    {
        $args = shortcode_atts( [
            'context'            => 'general',
            'tag'                => 'div',
        ...
        $tag = $args['tag'];
        return sprintf( '<%1$s class="wps-team--member-details wps-team--member-details-excerpt wps-team--member-element">%2$s</%1$s>', $tag, '{{=it.excerpt}}' );
    }
    
    public static function get_the_description( $post_id, $args = array() )
    {
        $args = shortcode_atts( [
            'context' => 'general',
        ], $args );
    ...
    public static function get_the_description_template( $args = array() )
    {
        $args = shortcode_atts( [
            'context' => 'general',
        ], $args );
    ...
    public static function get_the_social_links_template( $args = array() )
    {
        $title_text = plugin()->translations->get( 'social_links_title', _x( 'Connect with me:', 'Public', 'wpspeedo-team' ) );
        $args = shortcode_atts( [
            'context'    => 'general',
    ...
    public static function get_the_action_links_template( $args = array() )
    {
        $args = shortcode_atts( [
            'link_1' => false,
            'link_2' => false,
    ...
    public static function get_the_skills_template( $args = array() )
    {
        $args = shortcode_atts( [
            'context' => 'general',
        ], $args );
    ...
    public static function get_extra_info_fields( $args = array() )
    {
        $args = shortcode_atts( [
            'context' => 'general',
            'fields'  => [],
    ...
    public static function get_the_extra_info( $post_id, $args = array() )
    {
        ...
        foreach ( $fields as $field ) {
            ...
            if ( $field === Utils::get_taxonomy_name( 'group', true ) ) {
    ...
    public static function get_the_extra_info_template( $args = array() )
    {
        $args = shortcode_atts( [
            'context'            => 'general',
            'fields'             => [],
