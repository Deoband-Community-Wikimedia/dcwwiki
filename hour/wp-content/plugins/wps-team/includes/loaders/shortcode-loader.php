    ...
    public function set_attributes()
    {
        ...
        if ( $display_type === 'carousel' ) {
            ...
            $carousel_settings = [
                ...
                'gap'                  => sanitize_text_field( $this->get_setting( 'gap' ) ),
                'gap_tablet'           => sanitize_text_field( $this->get_setting( 'gap_tablet' ) ),
                'gap_small_tablet'     => sanitize_text_field( $this->get_setting( 'gap_small_tablet' ) ),
                'gap_mobile'           => sanitize_text_field( $this->get_setting( 'gap_mobile' ) ),
