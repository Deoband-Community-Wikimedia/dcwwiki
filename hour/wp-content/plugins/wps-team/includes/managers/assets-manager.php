...
abstract class Assets_Manager extends Style_Manager
{
    ...
    public function add_item_in_asset_list( $type, $item, $item_data = array() )
    {
    ...
    public final function enqueue_assets( $assets = array() )
    {
        if ( empty($assets) ) {
            return;
        }
    ...
    public final function enqueue_style_assets( $styles = array() )
    {
    ...
    public final function enqueue_script_assets( $scripts = array() )
    {
    ...
    public final function enqueue_font_assets( $fonts = array() )
    {
    ...
    protected function enqueue_google_fonts_force( $google_fonts = array() )
    {
        // Print used fonts
