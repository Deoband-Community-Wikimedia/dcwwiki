...
class Shortcode_Editor extends Editor_Controls
{
    ...
    {
        $show_group_filter = _x( 'Show Group Filter', 'Editor', 'wpspeedo-team' );
        $show_location_filter = _x( 'Show Location Filter', 'Editor', 'wpspeedo-team' );
        $show_language_filter = _x( 'Show Language Filter', 'Editor', 'wpspeedo-team' );
        $show_specialty_filter = _x( 'Show Specialty Filter', 'Editor', 'wpspeedo-team' );
        $show_gender_filter = _x( 'Show Gender Filter', 'Editor', 'wpspeedo-team' );
        $enable_multi_select = _x( 'Enable Multi Select', 'Editor', 'wpspeedo-team' );
        $filter_animation_speed = _x( 'Filter Animation Speed', 'Editor', 'wpspeedo-team' );
        $filter_inner_space = _x( 'Filter Inner Space', 'Editor', 'wpspeedo-team' );
        $filters_bottom_space = _x( 'Filters Bottom Space', 'Editor', 'wpspeedo-team' );
        $show_hide_filter_all = _x( 'Show/Hide Filter All', 'Editor', 'wpspeedo-team' );
        $initial_group_filter = _x( 'Initial Group Filter', 'Editor', 'wpspeedo-team' );
        $group_filter_all_text = _x( 'Group Filter All Text', 'Editor', 'wpspeedo-team' );
        $location_filter_all_text = _x( 'Location Filter All Text', 'Editor', 'wpspeedo-team' );
        $language_filter_all_text = _x( 'Language Filter All Text', 'Editor', 'wpspeedo-team' );
        $specialty_filter_all_text = _x( 'Specialty Filter All Text', 'Editor', 'wpspeedo-team' );
        $gender_filter_all_text = _x( 'Gender Filter All Text', 'Editor', 'wpspeedo-team' );
        $this->start_controls_section( 'filter_section', [
            'label'     => _x( 'Filter Settings', 'Editor', 'wpspeedo-team' ),
            'condition' => [
            'display_type' => 'filter',
        ],
        ] );
        $this->add_control( 'heading_filter_types', [
            'label' => _x( 'Filters', 'Editor', 'wpspeedo-team' ),
            'type'  => Controls_Manager::HEADING,
        ] );
        $this->add_control( 'show_group_filter', [
            'label'       => $show_group_filter,
            'label_block' => true,
            'type'        => Controls_Manager::UPGRADE_NOTICE,
        ] );
        $this->add_control( 'show_location_filter', [
            'label'       => $show_location_filter,
            'label_block' => true,
            'type'        => Controls_Manager::UPGRADE_NOTICE,
        ] );
        $this->add_control( 'show_language_filter', [
            'label'       => $show_language_filter,
            'label_block' => true,
            'type'        => Controls_Manager::UPGRADE_NOTICE,
        ] );
        $this->add_control( 'show_specialty_filter', [
            'label'       => $show_specialty_filter,
            'label_block' => true,
            'type'        => Controls_Manager::UPGRADE_NOTICE,
        ] );
        $this->add_control( 'show_gender_filter', [
            'label'       => $show_gender_filter,
            'label_block' => true,
            'type'        => Controls_Manager::UPGRADE_NOTICE,
        ] );
        $this->add_control( 'heading_filter_config', [
            'label' => _x( 'Filter Config', 'Editor', 'wpspeedo-team' ),
            'type'  => Controls_Manager::HEADING,
        ] );
        $this->add_control( 'layout_mode', [
            'label'       => _x( 'Layout Mode', 'Editor', 'wpspeedo-team' ),
            'label_block' => true,
            'type'        => Controls_Manager::SELECT,
