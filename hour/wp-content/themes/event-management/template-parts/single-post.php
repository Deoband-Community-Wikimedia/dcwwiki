...
<article id="post-<?php the_ID(); ?>" <?php post_class('inner-service'); ?>>
	...
	<?php }?>
    	...
    	<hr>
    <?php } ?>
    <?php if( get_theme_mod('event_management_show_hide_single_post_categories',true) != ''){ ?>
    ...
    <?php if( get_theme_mod( 'event_management_enable_single_post_pagination',true) != '') { ?>
	    <?php
			...
			if ( is_singular( 'attachment' ) ) {
				...
				if( get_theme_mod( 'event_management_enable_single_post_pagination',true) != '') {
				// Previous/next post navigation.
				the_post_navigation( array(
					'next_text' => '<span class="meta-nav" aria-hidden="true">' . esc_html(get_theme_mod('event_management_next_text', __( 'Next page', 'event-management' ))) . '</span> ' .
						'<span class="screen-reader-text">' . __( 'Next post:', 'event-management' ) . '</span> ' .
						'<span class="post-title">%title</span>',
					'prev_text' => '<span class="meta-nav" aria-hidden="true">' . esc_html(get_theme_mod('event_management_prev_text', __( 'Previous page', 'event-management' ))) . '</span> ' .
