...
$host = 'localhost';
$db   = 'u572932744_certsdb';
$user = 'u572932744_certsuser';
$pass = 'XD0iDcf4*l'; // Default XAMPP/WAMP empty password
$charset = 'utf8mb4';
...
define('SUPER_ADMIN_PASSCODE', '2194'); // Change 1234 to your secret PIN
